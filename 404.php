    ...
    <section id="contenido">
     ...
     <div class="row ">
                <div class="col-md-6 ">
                    <h1>Ups!</h1>
                    <h3>Error 404</h3>
                    <p>Al parecer el contenido que buscas ya no está o fue removido. intenta buscar en nuestro Catálogo </p>
                </div>
                <div class="col-md-6 ">
                <img src="images/404/404.webp" alt="error 404" class="img-fluid">
                            </div>
            </div>
     </section>
