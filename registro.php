...
<head>
    ...
    <title>Finnca</title>
        ...
        <link href="css/bootstrap-grid.css" rel="styleshee">
        <link href="css/bootstrap-reboot.css" rl="stylesheet">
        <link href="css/theme.css" rel="styleshee">
  ...
  <?php include 'header.php' ?>
    ...
    <!-- cabecera-secciones -->
                                    ...
                                    <input type="text" class="form-control" name="nombree" id="nombre" placeholder="">
                                                  ...
                                                  <div class="form-row">
                                                      ...
                                                      <div class="col">
                                                          ...
                                                          <input type="text" class="form-control" ame="giro" id="giro" placeholder="">
                                                            </div>
                                <div class="col">
         ...
         <footer id                 ="footer" class="blog-footer">
                ...
                <div class="col-md-3">
                                          <ul class="nav flex-column">
                                              <li class="nav-item"><a class="nav-link actie" href="#">Mi cuenta</a></li>
...
5">
    ...
    </footer>                         La Serena Región<de/CoquimbobChile
ody></p>
</html><script src="https://code.jquery.com/jquery-3.4.1.slim.min.js"></script>
                    <script src="js/bootstrap.min.js"></script>
                    <script src="js/bootstrap.bundle.js"></script>
             <script src="js/wo         w.min.js"></script>
                        
<script>                        
new WOW().init();
</script>                        LaSerenaRegióndeCoquimboChile
   </p>                    
